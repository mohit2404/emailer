...
export async function POST(req: Request) {
  ...
  try {
    ...
    //         <!-- TEXT SECTION -->
    //         <tr style="margin: 0; padding: 0; font-family: sans-serif">
    //           <td style="padding: 18px 0; margin: 0; font-family: sans-serif">
    //             <img
    //               src="https://images.staybook.in/Staybook%20posts%20(2).jpg"
    //               alt="banner_image"
    //               width="100%"
    //             />
    //             <p>Dear Student,</p>
    ...
    //               This internship will provide you with hands-on experience in Real
    //               world project and gain knowlege on React best practices and its
    //               server and client side rendering process. You will have the
    //               opportunity to work closely with our experienced team members and
    //               contribute to real-world projects that impact our company's
    //               success.
    //             </p>
    ...
    //             </p>
    //             <p>
    //               find company details attached
    //               https://www.canva.com/design/DAF8NMRbjiI/m0mSRrlZzPXVcUfhPuImlw/edit
    //             </p>
    //             <p>Best regards,</p>
    //           </td>
    //         </tr>
    ...
    //                                           line-height: 16px;
    //                                           white-space: nowrap;
    //                                           color: rgb(119, 119, 118) !important;
    //                                           padding: 1px 0px;
    //                                           vertical-align: middle;
    //                                         "
    //                                       >
    ...
    //                           deletion, so that we can ensure such a mistake does
